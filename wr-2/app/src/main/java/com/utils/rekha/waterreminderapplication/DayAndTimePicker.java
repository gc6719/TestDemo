        ...
        set_manual_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               show_time.setText(mtimePicker.getCurrentHour()+ ":"
                ...
                intent.putStringArrayListExtra("SELECTEDDAY",(ArrayList<String>)temp );
                intent.putExtra("SELECTED_HOUR",mtimePicker.getCurrentHour());
                intent.putExtra("SELECTED_MIN",mtimePicker.getCurrentMinute());
